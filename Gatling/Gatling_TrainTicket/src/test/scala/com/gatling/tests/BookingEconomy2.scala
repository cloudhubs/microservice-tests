...
class BookingEconomy2 extends Simulation {
	...
	val search = exec(http("Home Page")
		...
		.exec(http("Search for Trip")
			...
			.headers(headers_3)
			.body(RawFileBody("com/gatling/tests/bookingeconomy2/0003_request.json")))
		.pause(4)
	...
	val book = exec(http("Select Trip")
		...
		.exec(http("Custom Contact Form")
			...
			.headers(headers_9)
			.body(RawFileBody("com/gatling/tests/bookingeconomy2/0009_request.json"))
		...
		.exec(http("Submit Booking")
			...
			.headers(headers_9)
			.body(RawFileBody("com/gatling/tests/bookingeconomy2/0011_request.json")))
		.pause(6)
		.exec(http("Home Page")
			.get("/index.html")
			.resources(http("Get Fonts")
