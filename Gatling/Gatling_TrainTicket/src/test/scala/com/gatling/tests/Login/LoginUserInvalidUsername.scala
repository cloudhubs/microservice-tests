...
class LoginUserInvalidUsername extends Simulation {
  ...
  val scn = scenario("Login - Invalid Username")
    ...
    .exec(http("Request Login")
      ...
      .headers(headers_4)
      .body(RawFileBody("com/gatling/tests/logininvalidusername/0004_request.json")))
