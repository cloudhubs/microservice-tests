...
public class RegisterInvalidExistingUser {
  ...
  @Test
  public void testRegisterInvalidExistingUser() throws Exception {
    ...
    String errorVal = (String)js.executeScript("var emailVal = \"" + emailVal + "\";var passVal = \"" + passVal + "\";var storedVars = { 'emailVal': emailVal,'passVal': passVal }; return " + "\"Username 'test1@gmail.com' is already taken.\"" + "");
