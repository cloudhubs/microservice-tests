...
public class RegisterInvalidPasswordsDifferent {
  ...
  @Test
  public void testRegisterInvalidPasswordsDifferent() throws Exception {
    String emailVal = (String)js.executeScript(" return " + "\"test1@gmail.com\"" + "");
    String errorVal = (String)js.executeScript("var emailVal = \"" + emailVal + "\";var storedVars = { 'emailVal': emailVal }; return " + "\"The password and confirmation password do not match.\"" + "");
    ...
    errorMsg = (String)js.executeScript("var emailVal = \"" + emailVal + "\";var errorVal = \"" + errorVal + "\";var errorMsg = \"" + errorMsg + "\";var storedVars = { 'emailVal': emailVal,'errorVal': errorVal,'errorMsg': errorMsg }; return " + "\"" + errorMsg + "\"" + "");
    try {
      assertEquals(errorVal, js.executeScript("var emailVal = \"" + emailVal + "\";var errorVal = \"" + errorVal + "\";var errorMsg = \"" + errorMsg + "\";var storedVars = { 'emailVal': emailVal,'errorVal': errorVal,'errorMsg': errorMsg }; return " + "\"" + errorMsg + "\"" + ""));
    } catch (Error e) {
