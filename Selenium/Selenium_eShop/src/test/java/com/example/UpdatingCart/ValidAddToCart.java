...
public class ValidAddToCart {
  ...
  @Test
  public void testValidAddToCart() throws Exception {
    ...
    if (cartNumPrev > 0) {
      ...
      cartNumPrevStr = (String) driver.findElement(By.xpath("/html/body/header/div/article/section[3]/a/div[2]")).getText();
      cartNumPrev = Integer.parseInt(cartNumPrevStr);
    }
    assertEquals(cartNumPrev, 0);
