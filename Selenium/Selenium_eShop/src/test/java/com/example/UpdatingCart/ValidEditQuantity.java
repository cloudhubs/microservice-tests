...
public class ValidEditQuantity {
  ...
  @Test
  public void testValidEditQuantity() throws Exception {
    ...
    try {
      assertThat(cost1, is(not(driver.findElement(By.xpath("/html/body/form/div/div[2]/article[2]/section[5]")).getText())));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
      assertThat(cost1, is(not(driver.findElement(By.xpath("/html/body/form/div/div[2]/div[2]/article[2]/section[2]")).getText())));
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
