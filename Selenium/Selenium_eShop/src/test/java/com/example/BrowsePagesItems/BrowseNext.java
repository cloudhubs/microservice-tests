...
public class BrowseNext {
  ...
  public void testBrowseNext() throws Exception {
    ...
    subtitle = (String)js.executeScript("var subtitle = \"" + subtitle + "\";var storedVars = { 'subtitle': subtitle }; return " + "\"" + subtitle + "\"" + "");
    try {
      assertEquals("Page 2 - 2", js.executeScript("var subtitle = \"" + subtitle + "\";var storedVars = { 'subtitle': subtitle }; return " + "\"" + subtitle + "\"" + ""));
    } catch (Error e) {
