...
//    }
    ...
    public void testLoginDump1() {
        WebDriver driver = SetUpDriverChrome.Execute("./chromedriver.exe");
        // Check that you are logged out, and try to navigate to login page by clicking on profile
        driver.findElement(By.id("client_name")).click();
        driver.switchTo().alert().accept();
        assertEquals(CLIENT_LOGIN_URL, driver.getCurrentUrl());
        ...
        // Check that the fields are auto-populated
        driver.findElement(By.id("flow_preserve_login_email")).clear();
        driver.findElement(By.id("flow_preserve_login_email")).sendKeys("dummy1");
        assertEquals(driver.findElement(By.id("flow_preserve_login_email")).getAttribute("value"), "dummy1");
    }

    @Test
    public void testLoginDump2() {
        WebDriver driver = SetUpDriverChrome.Execute("./chromedriver.exe");
        // Check that you are logged out, and try to navigate to login page by clicking on profile
        driver.findElement(By.id("client_name")).click();
        driver.switchTo().alert().accept();
        ...
        // Check that the fields are auto-populated
        driver.findElement(By.id("flow_preserve_login_email")).clear();
        driver.findElement(By.id("flow_preserve_login_email")).sendKeys("dummy2");
        assertEquals(driver.findElement(By.id("flow_preserve_login_email")).getAttribute("value"), "dummy2");
    }
